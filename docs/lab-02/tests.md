...
| `API-03`  | API                    | FR-10, FR-30, AC-09–AC-11, AC-41               | Ticket creation validation and safe failure responses                                                      | Returns documented validation or safe error; saves no invalid Ticket                                   | `server/tests/lab-02/create-ticket.api.test.ts`                                                           | Planned |
