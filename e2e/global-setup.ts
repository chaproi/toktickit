...
import { prepareIssue27TestDatabase } from "../server/src/testing/prepare-issue27-test-database.js";
...
export default async function globalSetup(): Promise<() => Promise<void>> {
  ...
  const cleanupDatabase = await prepareIssue27TestDatabase(serverDirectory);
